# Sistema MiDoc — Documentación Técnica Completa (Legacy)

> Documento historico.  
> La documentacion vigente del sistema se mantiene en: **`docs/SISTEMA_ACTUAL.md`**.
> Indice de documentos: **`docs/INDICE_DOCUMENTACION.md`**.
>
> Motivo: el sistema evoluciono (suscripcion/onboarding, IA clinica endurecida, bot de WhatsApp bidireccional, directorio de pacientes por medico, trazabilidad y nuevas rutas API), y este archivo ya no refleja con precision el estado actual.

> Plataforma de gestión médica y agendamiento de citas para consultorios. Construida con **Next.js 16**, **PostgreSQL** (Prisma ORM), autenticación JWT y microservicio de notificaciones por WhatsApp.
