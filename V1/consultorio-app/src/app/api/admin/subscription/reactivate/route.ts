...
export async function POST(request: Request) {
  try {
    ...
    const result = await updateCancelAtPeriodEnd(authUser.id, false, {
    ...
    logEvent('info', 'billing.subscription.reactivated', {
      userId: authUser.id,
    ...
    captureError('billing.subscription.reactivate.error', error)
