...
| 26 | Perfil dentista completo (paridad Dentis365 + IA dental) | `superpowers:writing-plans` | Odontograma visual interactivo, indice de placa, plan de tratamiento presupuestado con saldos por avance, ordenes de laboratorio y capa IA dental (dictado al odontograma, nota de evolucion, indicaciones post-operatorias). | 🚧 IN PROGRESS (rebanadas 1 odontograma visual, 2 indice de placa, 3 presupuesto con saldos y 5a dictado al odontograma entregadas) |
