...
Estado: 🚧 EN PROGRESO — rebanada 1 entregada (2026-08-02) en `v2/paso27-frontera-datos`; restan 2, 3 y 4. Plan cerrado y sin decisiones abiertas en `14_plan_estaciones_y_roles.md`; seis decisiones de producto fijadas ahi (dos cajones, saldo a favor, reembolso solo con autorizacion del medico, recibo con detalle del tratamiento, defaults por perfil clinico, relevo por nube).
