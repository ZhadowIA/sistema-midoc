...
Estado: 📋 PLANEADO (2026-07-25) — no iniciado. Plan cerrado y sin decisiones abiertas en `14_plan_estaciones_y_roles.md`; seis decisiones de producto fijadas ahi (dos cajones, saldo a favor, reembolso solo con autorizacion del medico, recibo con detalle del tratamiento, defaults por perfil clinico, relevo por nube).
