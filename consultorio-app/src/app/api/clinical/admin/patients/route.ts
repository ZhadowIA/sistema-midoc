...
export async function GET(request: Request) {
  try {
      ...
      ...(q
        ? {
            OR: [
              ...
              { lastNamePaternal: { contains: q, mode: 'insensitive' as const } },
              { lastNameMaternal: { contains: q, mode: 'insensitive' as const } },
              { phone: { contains: q } },
            ],
          }
        : {}),
    ...
    const [patients, total, appointmentCounts] = await Promise.all([
